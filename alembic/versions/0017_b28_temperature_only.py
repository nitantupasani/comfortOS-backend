"""Trim Building 28 dashboard to temperature-only.

Drops the CO₂ gauge and both CO₂ comparison charts (floors and wings),
leaving a temperature-focused layout: banner, weather, room selector,
one temperature gauge, comfort progress bars, and the two temperature
comparison charts (floors + wings). HHS layout is unchanged.

Revision ID: 0017_b28_temperature_only
Revises: 0016_refresh_dashboards
"""
...
revision = "0017_b28_temperature_only"
down_revision = "0016_refresh_dashboards"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    """No-op: layout from 0016 stays in place."""
    pass
